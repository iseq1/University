...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\project under development\Python proj\minipr2'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\project under development\Python proj\minipr2\Scripts\deactivate.nu'
